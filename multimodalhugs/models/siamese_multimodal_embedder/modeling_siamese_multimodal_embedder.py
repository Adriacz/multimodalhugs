...
class SiameseMultiModalEmbedderModel(MultiModalEmbedderModel):
    ...
    # ------------------------------------------------------------------
    # Encoder routing for generate() — audio eval via EncoderWrapper
    # ------------------------------------------------------------------
